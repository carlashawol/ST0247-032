...
void imprimir_LCS(char X[], int i, int j) // Imprime cada Ocurrencia del Vector B en A
{
    if (i==0 || j==0)
       return ;
    if (b[i][j]=='/')
...
//tomado de: http://xcodigoinformatico.blogspot.com/2012/09/subsecuencia-comun-mas-larga-con.html
